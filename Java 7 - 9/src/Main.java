...
public class Main {
  ...
  public static void main(String[] args) throws NumberFormatException, IOException {
	  if (("10.0.0".compareTo(System.getProperty("java.version")) <= 0)) {
		  System.out.println("Your version: "+System.getProperty("java.version") +" is to high for this Application");
		  System.out.println("Pleas use the other jar from my Repository: https://github.com/HKS-HNS/Arduino-Terminal");
		  return;
	  }
